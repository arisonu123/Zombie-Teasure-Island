...
#pragma warning disable 649
    ...
    [SerializeField]
    private UnityEngine.UI.Button buttonForBuying;
#pragma warning restore 649
    ...
    {
        ZPlayerPrefs.SetString("Was" + itemName + "sold in" + levelApplied, "Bought");
        isBought = true;
        switch (itemMod)
        {
    ...
    /// <summary>
    /// Gets/sets the button used for purchasing this item
    /// </summary>
    /// <value>The button used for purchasing this item</value>
    public UnityEngine.UI.Button buttonForPurchasing
    {
        get { return buttonForBuying; }
        set { buttonForBuying = value; }
    }

    /// <summary>
    /// Gets whether or not this item has been sold
    /// </summary>
    /// <value>Whether or not this item has been sold</value>
    public bool isSold
    {
        get { return isBought; }
    }
